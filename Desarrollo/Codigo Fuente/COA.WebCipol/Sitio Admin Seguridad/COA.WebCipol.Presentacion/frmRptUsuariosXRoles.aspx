<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRptUsuariosXRoles.aspx.cs"
    Inherits="COA.WebCipol.Presentacion.frmRptUsuariosXRoles" MasterPageFile="~/EstructuraReportes.Master" %>
                                           ...
                                           <div class="row" style="margin:0 0 22px 0;">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="cboRol" runat="server" class="col-md-10 select-no-padding" > </asp:DropDownList>
                                                    </div>
                                                </div>
