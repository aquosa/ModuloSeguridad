...
{
    [System.Serializable()]
    public class SE_SIST_HABILITADOS : IEditableObject
    {
        ...
        /// </summary>
        public class Sort : IComparer<SE_SIST_HABILITADOS>
        {
            public int Compare(SE_SIST_HABILITADOS x, SE_SIST_HABILITADOS y)
            {
