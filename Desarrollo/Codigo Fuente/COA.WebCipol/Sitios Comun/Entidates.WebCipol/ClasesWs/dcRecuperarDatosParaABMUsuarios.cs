...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarDatosParaABMUsuarios
{
    [Serializable]
    public class dcRecuperarDatosParaABMUsuarios
    {
        public dcRecuperarDatosParaABMUsuarios()
        {
