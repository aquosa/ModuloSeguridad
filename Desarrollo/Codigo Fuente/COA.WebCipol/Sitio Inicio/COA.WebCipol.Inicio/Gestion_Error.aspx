<%@ Page Language="C#" MasterPageFile="~/EstructuraSitioSimplePadre.Master" AutoEventWireup="true" CodeBehind="Gestion_Error.aspx.cs" Inherits="COA.WebCipol.Inicio.Gestion_Error" %>
                    ...
                    <div class="row row-filter" onclick="javascript:slideSidebar('divMensaje, 'imgMensaje');">
                        <div class="col-md-12">
                            <div class="head">
                                ...
                                <div style="float:right;margin-top: -3px"><img src="Images/menos.png"  id="imgMensaje" alt=""/></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-filter" onclick="javascript:slideSidebar('divOrigen, 'imgOrigen');">
                        <div class="col-md-12">
                            <div class="head">
                                ...
                                <div style="float:right;margin-top: -3px"><img src="Images/menos.png"  id="imgOrigen" alt=""/></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-filter" onclick="javascript:slideSidebar('divStackTrac, 'imgDatos');">
                        <div class="col-md-12">
                            <div class="head">
                                ...
                                <div style="float:right;margin-top: -3px"><img src="Images/menos.png"  id="imgDatos" alt=""/></div>
                            </div>
                        </div>
                    </div>
