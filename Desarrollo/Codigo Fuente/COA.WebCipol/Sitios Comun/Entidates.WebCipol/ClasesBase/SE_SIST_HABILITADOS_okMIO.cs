...
{
    [System.Serializable()]
    public class SE_SIST_HABILITADOS_okMIO : IEditableObject
    {
        ...
        /// </summary>
        public class Sort : IComparer<SE_SIST_HABILITADOS_okMIO>
        {
            public int Compare(SE_SIST_HABILITADOS_okMIO x, SE_SIST_HABILITADOS_okMIO y)
            {
