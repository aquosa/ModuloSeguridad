<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmABMSistemas.aspx.cs"
    Inherits="COA.WebCipol.Presentacion.frmABMSistemas" MasterPageFile="~/EstructuraSitio.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript" src="js/Sistemas/jsfrmABMSistemas.js"></script>
    <script type="text/javascript" src="js/Sistemas/JQueryGridSistemas.js"></script>
    <link href="Estilos/metro-bootstrap.css" rel="stylesheet" type="text/css" />
    ...
    .tile.green{background:#009fa1}
    
    .tile-status{ text-align:center}
    
    .metro .tile .tile-content.icon [class*="icon-"], 
    .metro .tile .tile-content.icon img{ margin-top:-38px}
...
<asp:Content ID="Content2" ContentPlaceHolderID="CuerpoPagina" runat="server" >
    <section id="areas">
        <div class="container">
            ...
            <button id="btnFiltro" style="display: none" data-bind='click: cmdRecuperarSistemas'></button>
            <!-- Grilla-->
            <div class="row ">
            	<div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form col-md-12">
                                        <div class="row">
                                            <div class="col-xs-4 border">
                                                <div class="form-group">
                                                    <label for="txtIDSistema" class="col-xs-7 control-label">Id Sistema: </label>
                                                    <input type="text" value="" class="col-xs-4" id="txtIDSistema" maxlength="3" name="codigoTerminal"/>
                                                    <span class="col-xs-1 required">*</span>
                                                </div>
                                            </div>
                                            <div class="col-xs-5 border">
                                                <div class="form-group">
                                                    <label for="txtCodSistema" class="col-xs-4 control-label">Código del sistema: </label>
                                                    <input type="text" value="" class="col-xs-6" id="txtCodSistema" name="codigo-sistema" onkeypress="jfNopermitirSPACE(this, event)"/>
                                                    <span class="col-xs-1 required">*</span>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    ...
                                                    <label for="chkHabilitado" class="col-xs-4 control-label"> Habilitado</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row grey">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <label for="txtNombreEXE" class="col-xs-4 control-label">Nombre del EXE:</label>
                                                    <input type="text" value="" MaxLength="100" class="col-xs-8" id="txtNombreEXE" name="nombreEXE"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-7 border">
                                                <div class="form-group">
                                                    <label for="txtNombreIcono" class="col-xs-2 control-label">Icono: </label>
                                                   <%-- <input type="text" value="" MaxLength="30" class="col-xs-8" id="txtNombreIcono" name="nombre-icono"/>--%>
                                                    <button type="button"  id="btnIconSelect" class="btn green">Seleccionar</button>
                                                   <i id="iIcon"> <span id="txtIconName"></span></i>
                                                   <input type="hidden" id="hdnIconValue" />
                                               </div>
                                            </div>
                                            <div class="col-md-3 border">
                                                <div class="form-group">
                                                    ...
                                                    <div id="violet" class="square violet"></div>
                                                    <div id="orange" class="square orange"></div>
                                                
                                                </div>
                                            </div>
                                             <div class="col-md-2">
                                                <div class="form-group">
                                                    <a href="#" id="lnkViewPreview"><small>Vista Previa</small></a>
                                        ...
                                        <div class="row grey">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <label for="txtPaginaPOrDefecto" class="col-xs-2 control-label">Página por defecto: </label>
                                                    <input type="text" value="" class="col-xs-8" id="txtPaginaPOrDefecto" name="pagina-por-defecto" maxlength="100"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12 border">
                                                <div class="form-group">
                                                    <label for="txtDescripcion" class="col-xs-2 control-label">Descripción: </label>
                                                    <textarea  class="col-xs-7" id="txtDescripcion" name="decripcion" onkeypress="if (this.value.length > 49) { return false; }"  MaxLength="50"></textarea>
                                                    <span class="col-xs-1 required">*</span>
                                                </div>
                                            </div>
                                        </div>
            ...
            <!--Fin PopUP-->
             <div id="dialogViewPreview" class="ui-dialog">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box1">
                            <div class="row">
                                <div class="head">
                                    <span class="white">Icono - Vista Previa</span>
                                </div>
                            </div>
                              <div class="col-md-12">
                                    <div class="form col-md-12">
                                        ...
                                        <div class="row metro">
                                            <div class="tile bg-darkPink" id="titlePrev" style="margin-left:3px">
                                                <div class="tile-content icon">
                                                    <i class="icon-cart-2" id="iconPrev"></i>
                                                </div>
                                                <div class="tile-status">
                                                    <span class="name" id="name">Store</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div id="popupIcon" class="ui-dialog">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box1">
                            <div class="row">
                                <div class="head">
                                    <span class="white">ICONOS</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
