<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRptRolesXUsuarios.aspx.cs"
    Inherits="COA.WebCipol.Presentacion.frmRptRolesXUsuarios" MasterPageFile="~/EstructuraReportes.Master" %>
                                           ...
                                           <div class="row" style="margin:0 0 22px 0;">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="lblFechaDesde" class="col-md-2 control-label">USUARIO:</label>
                                                        <asp:DropDownList ID="cboUsuario" runat="server" class="col-md-10 select select-no-padding"> </asp:DropDownList>
                                                                     </div>
                                                </div>											  
                                            </div>
