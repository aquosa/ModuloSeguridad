...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarReporteRolesXUsuario
{
    [Serializable]
    public class dcRecuperarReporteRolesXUsuario
    {
        /*
         * RolesXUsuarios
         * SE_TAREAS_USUARIO
         */
        public dcRecuperarReporteRolesXUsuario()
        {
