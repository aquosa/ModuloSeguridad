...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarReporteControlInactividad
{
    [Serializable]
    public class dcRecuperarReporteControlInactividad
    {
        /*
         * Sist_Usuarios
         */
        public dcRecuperarReporteControlInactividad()
        {
