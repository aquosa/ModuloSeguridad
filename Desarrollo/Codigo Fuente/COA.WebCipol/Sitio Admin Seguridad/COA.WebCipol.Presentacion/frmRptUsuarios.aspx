<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRptUsuarios.aspx.cs"
    Inherits="COA.WebCipol.Presentacion.frmRptUsuarios" MasterPageFile="~/EstructuraReportes.Master" %>
                                           ...
                                           <div class="row" style="margin:0 0 22px 0;">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="cboUsuario" runat="server" class="col-md-10 select-no-padding"> </asp:DropDownList>
                                                                     </div>
                                                </div>
											</div>
