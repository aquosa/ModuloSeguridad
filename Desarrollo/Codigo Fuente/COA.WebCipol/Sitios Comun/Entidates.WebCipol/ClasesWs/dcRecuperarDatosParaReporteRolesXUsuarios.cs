...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarDatosParaReporteRolesXUsuarios
{
    [Serializable]
    public class dcRecuperarDatosParaReporteRolesXUsuarios
    {
        /*
         * Sist_Usuarios
         */
        public dcRecuperarDatosParaReporteRolesXUsuarios()
        {
