...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarReporteUsuarioSinAcceso
{
    [Serializable]
    public class dcRecuperarReporteUsuarioSinAcceso
    {
        /*
         * Sist_Usuarios
         */
        public dcRecuperarReporteUsuarioSinAcceso()
        {
