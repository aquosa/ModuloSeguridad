...
{
    public partial class frmRptUsuariosXRoles : PaginaPadre
    {
        /// <summary>
        ...
        protected void cmdGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int intIDRol = Convert.ToInt32(cboRol.SelectedValue);

                List<COA.WebCipol.Entidades.ClasesWs.dcRecuperarReporteUsuariosXRol.RolesXUsuarios> lstRoles = objFac.RecuperarReporteUsuariosXRol(intIDRol);
                ...
                VisualizarReporte.LocalReport.ReportPath = this.MapPath("~/Reportes/rptUsuariosXRoles.rdlc");
