...
namespace COA.Cipol.Presentacion._UIHelpers
{
    ...
    internal class ManejoSesion
    {
        ...
        public static int IdAutorizacion
        {
            get
            {
                return (int)HttpContext.Current.Session[Constantes.VariablesDeSesion.IDAUTORIZACION];
            }
            set
            {
                HttpContext.Current.Session[Constantes.VariablesDeSesion.IDAUTORIZACION] = value;
            }
        }
        #endregion
        ...
        #region COMPORTAMIENTO
         ///<summary>
         ///Cierra la sesión de usuario y fuerza el logout del Sistema.
         ///</summary>
         //<returns></returns>
