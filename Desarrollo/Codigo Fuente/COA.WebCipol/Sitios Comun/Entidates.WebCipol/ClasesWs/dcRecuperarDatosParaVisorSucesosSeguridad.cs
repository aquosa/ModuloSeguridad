...
namespace COA.WebCipol.Entidades.ClasesWs.dcRecuperarDatosParaVisorSucesosSeguridad
{
    [Serializable]
    public class dcRecuperarDatosParaVisorSucesosSeguridad
    {
        public List<Sist_UsuariosConTareasCipol> lstSist_UsuariosConTareasCipol { get; set; }
        public List<SE_CODAUDITORIA> lstCodAuditoria { get; set; }
        public List<Sist_Usuarios> lstSistUsuarios { get; set; }
    ...
    [Serializable]
    public class Sist_UsuariosConTareasCipol
    {
        ...
        public Sist_UsuariosConTareasCipol()
        {
            this.idUsuarioField = -2;
            this.usuarioField = "_";
            this.nombresField = "_";
